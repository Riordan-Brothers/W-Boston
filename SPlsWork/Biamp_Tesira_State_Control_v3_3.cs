...
namespace UserModule_BIAMP_TESIRA_STATE_CONTROL_V3_3
{
    public class UserModuleClass_BIAMP_TESIRA_STATE_CONTROL_V3_3 : SplusObject
    {
...
public UserModuleClass_BIAMP_TESIRA_STATE_CONTROL_V3_3 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
